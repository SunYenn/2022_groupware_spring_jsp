        ...
        <div class="con_middle">
            ...
            <div class="Manager_Main" align="center">   
            	...
            	<div onclick="location.href='account_approval'">
            		<div>
            			<span class="Marking">계정 승인 대기 목록</span>
           				<c:if test="${waitingList.empList.size() != 0}">
    	        			<p>
            		...
            		<div>
            			<table width = "100%">
	            			...
	            			<c:forEach var="waitlist" items="${waitingList.empList}" end="5">
	            				<tr>
            	...
            	<div>
            		...
            		<div>
            			<table width = "100%">
            				<c:if test="${appList.appList.size() == 0}">
								<tr>
									<td colspan="7" style="text-align: center;">대기 목록이 없습니다.</td>
								</tr>
							</c:if>
	            			<c:forEach var="app" items="${appList.appList}" end="5">
