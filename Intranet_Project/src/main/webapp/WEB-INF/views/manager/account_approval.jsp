        ...
        <div class="con_middle">
			<div class="nav">
                <ul>
                    ...
                    <li><a href="account_approval">인명관리</a>&#62;</li>
            ...
            <div align="center">   
            	...
            	<table class="acc_approv_list">
            		...
            		<tbody>
            			<c:set var="list" value="${waitingList.empList}"></c:set>
						...
						<c:if test="${list.size() != 0}">
							<c:forEach var="vo" items="${list}">
								<tr id="tr${vo.empno}">
									...
									<td><input id="incnum${vo.empno}" type="text" onkeyup="pernumCheckFunction(this)"/></td>
