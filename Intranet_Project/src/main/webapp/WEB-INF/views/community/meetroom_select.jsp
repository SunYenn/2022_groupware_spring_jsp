        ...
        <div class="con_middle">
            ...
            <div class="select_room">
            	...
            	<table>
            		...
            		<tbody>
            			<c:forEach var="li103" items="${list103.meetRmList}">
            				<tr>
            			...
            			<c:forEach begin="1" end="${5 - list103.meetRmList.size()}">	
            	...
            	<table>
            		...
            		<tbody>
            			<c:forEach var="li222" items="${list222.meetRmList}">
            				<tr>
            			...
            			<c:forEach begin="1" end="${5 - list222.meetRmList.size()}">	
	            				<tr><td style="border-bottom: 2px solid #D8D2CB; height: 55px"></td></tr>
            			</c:forEach>	
            		</tbody>
            		<tfoot>
            	...
            	<table>
            		...
            		<tbody>
            			<c:forEach var="li503" items="${list503.meetRmList}">
            				<tr>
            			...
            			<c:forEach begin="1" end="${5 - list503.meetRmList.size()}">	
	            				<tr><td style="border-bottom: 2px solid #D8D2CB; height: 55px"></td></tr>
            			</c:forEach>		
            		</tbody>
            		<tfoot>
            	...
            	<table>
            		...
            		<tbody>
            			<c:forEach var="li710" items="${list710.meetRmList}">
            				<tr>        				
            			...
            			<c:forEach begin="1" end="${5 - list710.meetRmList.size()}">	
	            				<tr><td style="border-bottom: 2px solid #D8D2CB; height: 55px"></td></tr>
            			</c:forEach>	
            		</tbody>
            		<tfoot>
            	...
            	<table>
            		...
            		<tbody>
            			<c:forEach var="li901" items="${list901.meetRmList}">
            				<tr>
            			...
            			<c:forEach begin="1" end="${5 - list901.meetRmList.size()}">	
	            				<tr><td style="border-bottom: 2px solid #D8D2CB; height: 55px"></td></tr>
            			</c:forEach>		
            		</tbody>
            		<tfoot>
            ...
            <div class="select_room_footer">
            	<button onclick="location.href='${path}/board/meetroom_main?year=${meetdata.year}&month=${meetdata.month}'">돌아가기</button>
            </div>
			<!-- =================================contents================================================= -->
