        ...
        <div class="con_middle">
            <div class="nav">
                <ul>
                    ...
                    <li><a href="move_board_list?category=자유 게시판">게시판</a>&#62;</li>
                    <li><a href="move_board_list?category=자유 게시판">자유게시판</a>&#62;</li>
                    <li>글 수정</li>
                </ul>
            </div>
            <!-- =================================contents================================================= -->
            ...
            <div class="content_view">
				...
				<form action="board_updateOK?idx=${vo.idx}&currentPage=${currentPage}&category=자유 게시판" method="post">					
					<textarea id="content" name="content" style="resize: none;" rows="11" >${content}</textarea>
					<br/>
					<div align="right">
