        ...
        <div class="con_middle">
            <div class="nav">
                <ul>
					...
					<li><a href="${path}/board/move_board_list?category=공지사항">게시판</a>&#62;</li>
					...
					<table> 
						...
						<c:if test="${view.size() != 0}">					
							<c:forEach var="vo" items="${view}">
								...
								<tr onclick="location.href='content_list?idx=${vo.idx}&currentPage=${BoardList.currentPage}&category=공지사항'">
									<td align="center">${vo.deptname}</td>
									<td align="center">
