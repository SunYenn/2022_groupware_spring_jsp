	...
	<div class="tjcontainer">
		...
		<div class="con_middle">
			...
			<div class="cash-form-section">
				<form action="${path}/approval/expenseReport_insert" method="POST" id = "erWriteForm" name="erWriteForm" onsubmit="return check_onclick()">
								...
								<tr class="signup">
				                    <td colspan="8">
					                    <div>
					                        ...
					                        <span>영수인 :  </span><textArea name="proposerText" id="proposerText" disabled="disabled"></textArea> <span>(인)</span>
				                        </div>
				                    </td>
								</tr>
							</tbody>
